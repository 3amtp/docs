...
Portal includes booking widget integration:
- Get widget UUID: `getWidgetUUID()`
- Embed booking widget in portal
...
Portal có link download mobile app:
- Send link via SMS
